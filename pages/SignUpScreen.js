    ...
    <View style={styles.container}>
      ...
      <View style={styles.containerChild}>
        ...
        <View style={[styles.inputContainer, confirmPasswordError ? {borderColor: 'red'} : null]}>
         <Icon name="lock" size={27} color={confirmPasswordError ? "red" : "black"}  style={styles.icon} />
          <TextInput 
          style={styles.input}
        ...
        {confirmPasswordError ? <Text style={styles.errorText}>{confirmPasswordError}</Text> : <Text style={styles.errorText}></Text>}
